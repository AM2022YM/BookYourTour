...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".0001s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown; color:darkblue;">Recover Password</h3>
		<form name="chngpwd" method="post" onSubmit="return valid();">
			...
			<p style="width: 350px;">
			<b style="color:black;">Confirm Password</b>
