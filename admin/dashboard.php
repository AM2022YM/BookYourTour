		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
								<h3><a href="manage-users.php" style="color:white;">User</a></h3>
...
$cnt=$query->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<h3><a href="manage-bookings.php" style="color:white;">Bookings</a></h3>
...
$cnt1=$query1->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3><a href="manage-enquires.php" style="color:white;">Enquiries</a></h3>
...
$cnt2=$query2->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							...
							<div class="four-text">
								<h3><a href="manage-packages.php" style="color:white;">Total packages</a></h3>
		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3><a href="manageissues.php" style="color:white;">Issues Riaised</a></h3>
